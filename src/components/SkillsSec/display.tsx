...
export default function Display(){
  ...
  return(
    <div className="box-border border-2 rounded-sm border-c-gray100 display w-3/5 mt-20 mx-auto h-120 relative overflow-hidden">
      <div className=" box-content border-l-2 rounded-sm border-c-gray100 overflow-hidden w-4/5 bg-gray-600 absolute h-full right-0">
        <Image height={'480'} width='1440' alt=""  style={{ objectPosition:"60px -60px", filter:"blur(2px)", height:'200%', objectFit:'cover', }} src={FirstImage.src} />
      </div>
      <div className=" box-content border-l-2 rounded-sm border-c-gray100
      ...
      <div className=" box-content border-l-2 rounded-sm border-c-gray100 overflow-hidden -skew-x-25 w-1/3 absolute h-full -right-32">
      ...
      <div className="z-30 bg-white absolute h-full -right-32">
        <Image height={'480'} width='1440' alt=""  style={{transform:"skew(25deg,0) translatex(-80px)",height:'100%',width:'100%',position:'absolute', objectFit:'cover', }} src={''} />
      </div>
      <div>

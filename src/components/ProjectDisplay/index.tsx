  ...
  return(
    <motion.ul 
      ...
      <div className="flex flex-col">
        <WideLabel href='#projects' className="ss:hidden mb-4" index={1} img={ProjectOne} text={'Projetos'} />
        <WideLabel href='#contact' className="ss:hidden ml-12" index={0} img={ProjectTwo} text={'Fale Comigo'} />
      ...
      <motion.div 
        ...
        <svg className='
          ...
          <polygon 
              strokeWidth={2} fill='#00000034' stroke='#ffffff' points="20,20 100,20 60,90"   strokeDasharray="40" strokeDashoffset={30}    />
        </svg>
        <p className={`
        ${blanka.className}
        text-c-green500
      ...
      <div className=" flex flex-col">
        <WideLabel className="ml-12 ss:ml-0 mb-4" href='#projects' index={0} img={ProjectThree} text={'Projetos'} />
        <WideLabel className="" index={1} href='#about-me' img={ProjectFour} text={'Sobre mim'} />
      </div>
